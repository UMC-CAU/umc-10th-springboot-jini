...
import com.example.jini_umc10th.global.security.dto.KakaoDTO;
import com.example.jini_umc10th.global.security.dto.OAuthDTO;
import com.example.jini_umc10th.global.security.entity.OAuthMember;
...
import static com.example.jini_umc10th.domain.member.enums.SocialProvider.KAKAO;

@Service
@RequiredArgsConstructor
// 사용자 정보를 가지고 DB에 저장 or 조회
public class CustomOAuthService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(
        ...
        try {
            providerId = SocialProvider.valueOf(userRequest.getClientRegistration().getRegistrationId().toUpperCase());
        ...
        Member member = memberRepository.findBySocialProviderAndSocialUid(providerId, socialUid)
                .orElseGet(() -> {
